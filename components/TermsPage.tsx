...
const TermsPage: React.FC<TermsPageProps> = ({ onBack, onPrivacyClick }) => {
  return (
          ...
          <div className="pt-12 border-t border-zinc-900">
            <div className="flex items-center gap-4 p-6 bg-green-500/10 border border-green-500/20 rounded-2xl">
              ...
              <p className="text-sm text-zinc-400">
                We take your privacy seriously. By using DraftMaster FC, you also agree to our <button onClick={onPrivacyClick} className="text-white font-bold cursor-pointer hover:underline">Privacy Policy</button>.
              </p>
            </div>
          </div>
